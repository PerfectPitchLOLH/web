...
export const ERROR_CODES = {
  ...
  ACTIVE_JOBS_LIMIT_REACHED: 'ACTIVE_JOBS_LIMIT_REACHED',
...
export const ERROR_MESSAGES = {
  ...
  ACTIVE_JOBS_LIMIT_REACHED: 'Too many transcriptions in progress',
  EMAIL_NOT_VERIFIED: 'Email address not verified',
  AUDIO_TOO_LONG: 'Audio exceeds the allowed duration',
  AUDIO_UNREADABLE: 'Audio duration could not be read',
  ...
  SUBSCRIPTION_NOT_CANCELING: 'Subscription is not scheduled for cancellation',
  SUBSCRIPTION_ITEM_NOT_FOUND: 'Subscription item not found',
  PURCHASE_NOT_FOUND: 'Purchase record not found',
